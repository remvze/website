---
title: 'Doubly Linked Lists in TypeScript'
...
A **doubly linked list** is a linear data structure consisting of nodes where each node contains three parts: a **value** element, a reference (or pointer) to the **next node**, and a reference to the **previous node**. This bidirectional linking allows traversal in both forward and backward directions, making certain operations like insertion or deletion at both ends or in the middle more efficient compared to a singly linked list.
